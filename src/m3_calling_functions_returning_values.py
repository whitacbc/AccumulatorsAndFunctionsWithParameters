...
def run_test_sum_of_digits():
    ...
    # Test 2:
    expected = 18
    answer = sum_of_digits(7650)
    print("Test 1 expected:",expected)
    print("       actual:  ",answer)

    #Test 3:
    expected = 90
    answer = sum_of_digits(85472294857329348)
    print("Test 1 expected:",expected)
    print("       actual: ",answer)
...
def run_test_digits_in_power():
    ...
    #test 1
    expected = 56
    answer = digits_in_power(5,17)
    print("Test 1 expected:", expected)
    print("       actual: ", answer)

    #test 2
    expected = 45
    answer = digits_in_power(543,5)
    print("Test 1 expected:", expected)
    print("       actual: ", answer)
...
def run_test_fancy_sums_of_digits():
    ...
    #test 1
    expected = 49984
    answer = fancy_sums_of_digits(50)
    print("Test 1 expected:", expected)
    print("       actual: ", answer)

    #test 2
    expected =60496
    answer = fancy_sums_of_digits(70)
    print("Test 1 expected:", expected)
    print("       actual: ", answer)

    #test 3
    expected = 92305
    answer = fancy_sums_of_digits(44)
    print("Test 1 expected:", expected)
    print("       actual: ", answer)
